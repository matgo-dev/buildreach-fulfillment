...
from app.rbac.redaction import SKU_COST_FIELDS, redact_fields
...
def sku_out(sku, *, include_cost: bool, spu_main_image: str | None = None,
    ...
    """
    data = redact_fields(SkuOut.model_validate(sku).model_dump(),
                         SKU_COST_FIELDS, visible=include_cost)
