// 逆向/撤销导览页的数据源。只描述当前已落地的基础回退与出库前逆向申请 MVP。
...
export const REVERSE_FLOW_PRINCIPLES = [
  ...
  "作废、撤销、反核销和逆向申请都保留业务痕迹;当前不是完整财务凭证或库存流水账。",
];
        ...
        children: [
          {
            ...
            result: "线上入口会被拦截;出库前可发起履约中取消申请,由申请承载实物与财务处理结论。",
            severity: "goods",
          },
          {
...
export const REVERSE_FLOW_BOUNDARIES = [
  "这张图覆盖出库前的基础取消、撤销、作废、反核销,以及履约中取消申请 MVP。",
  "履约中取消申请只承载审批和处置结论;关闭申请只是登记线下处置说明,当前不自动冲销应付、不自动退款、不自动扣减或转移库存。",
