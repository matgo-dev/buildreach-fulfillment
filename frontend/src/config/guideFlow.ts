...
export const GUIDE_NODES: GuideNode[] = [
  ...
  },
  {
    ...
    effect: "现有规则下,创建入库单不产生库存,也不产生应付或应收。它只是说明货已经在路上,还没有被系统认作已收货。",
  ...
  },
  {
    ...
    effect: "现有规则下,确认入库的那一刻才产生库存,同时系统自动记下「我们欠供应商这笔钱」。客户侧应收仍然等确认出库时才产生。",
  ...
  },
  {
    ...
    role: "FINANCE",
    layer: "MONEY",
    anchorId: "inboundReceive",
    inEdgeLabel: "确认入库后,开始欠供应商钱",
    tooltip: "确认入库时自动产生,不用手工建。",
    what: "货到货代仓并确认入库的那一刻,系统自动记一笔「我们欠供应商多少钱」。和应收一样,是自动产生的。",
    fromTo: "上一步:确认入库。下一步:付款后登记付款单来冲抵。在左侧菜单「财务」→「应付款」里查看。",
    effect: "应付款的状态(未付 / 部分付 / 已付清)按已经付了多少自动算。",
    narration: "货到货代仓确认入库时,系统记下我们欠瓷砖厂的货款。",
  },
  {
    id: "payment",
    iconKey: "payment",
